...
class APDataAnalysis:
    ...
    def normalize_subjects(self):
        ...
        self.merged_data = self.merged_data[self.merged_data['loan_amount_000s'] <= 300]
    ...
    def plot_data(self):
        ...
        ax.plot(np.linspace(min(self.merged_data['loan_amount_000s']), max(self.merged_data['loan_amount_000s']), 100), y, 'k', linewidth=2, label='Fit')
